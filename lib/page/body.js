    ...
    for (let i = 0; i < prop.length; i++) {
      ...
      switch (attribute.name) {
        ...
        case 'o-animation': {
          ...
          dom.removeAttribute('o-animation')
          break
        }
      }
    }
...
function scriptHandle (pageInfo, scriptCode, moduleScript) {
  ...
  switch(pageInfo.type) {
    ...
    case 'route': {
      ...
      moduleScript.route[pageName] = scriptCode
      moduleScript.route[pageName].prop = pageInfo.prop
      moduleScript.route[pageName].propMap = pageInfo.propMap
      return moduleScript.route[pageName]
    }
  }
}
