    ...
    return new Promise((resolve, reject) => {
      ...
      if (this.config.pageList.length === 1) {
        ...
        useAnimationList.forEach(goValue => {
          ...
          if (goValue.backInAnimation) this.pageAnimationList.add(goValue.backInAnimation)
          if (goValue.backOutAnimation) this.pageAnimationList.add(goValue.backOutAnimation)
          if (goValue.ani) {
