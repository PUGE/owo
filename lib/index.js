        ...
        if (changePath === undefined || changePath === fromPath) {
          ...
          if (element.resource) {
            ...
            fs.readFile(fromPath, (err, fileData) => {
              ...
              if (err) throw err
              fileData = resourceHandle(fileData.toString(), this.config, this.config.outPut.merge? this.basePath : '../../', this.staticPath)
  ...
  handleStyle(dom) {
    return new Promise((resolve, reject) => {
      ...
      if (this.config.resourceFolder) {
        outPutCss = resourceHandle(outPutCss, this.config, this.config.outPut.merge? this.basePath : '../../', this.staticPath)
