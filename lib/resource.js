...
import imageminJpegtran from 'minimum-jpeg';
import imageminPngquant from 'minimum-png';
import fs from 'fs'
...
class Resource {
  ...
  handle (textData, config, basePath) {
    ...
    let outResourceFolder = path.join(staticPath, 'images')
    let prefix =  `${basePath}images/`
  ...
  async miniImg (imageList, outResourceFolder) {
    ...
    // console.log(image, outResourceFolder)
